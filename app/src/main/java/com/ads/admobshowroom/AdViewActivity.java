...
public class AdViewActivity extends Activity {
    ...
    //public final static String AD_UNIT_ID = "ca-app-pub-7175116050588696/2767439556";
    //public final static String AD_UNIT_ID = "ca-app-pub-7175116050588696/1040991152"; // temporary for IAP house ads
	public final static String AD_UNIT_ID =  "ca-app-pub-2412876219430673/6669260544"; // official test adunit id for IAP house ads
	...
	protected void sendAnalytics(String type, String size)
	{
		...
		tracker.set(Fields.customDimension(DIMENSION_AD_UNIT_TYPE),type );
		tracker.set(Fields.customDimension(DIMENSION_AD_SIZE),size);
	...
	protected void onCreate(Bundle savedInstanceState) {
	    ...
	    case R.id.ButtonInterstitial:
            ...
            PlayStorePurchaseListener IAPListener = new PlayStorePurchaseListener() {
                @Override
                ...
                public void onInAppPurchaseFinished(InAppPurchaseResult result) {
                    ...
                    appendStatusText("In-app purchased result code: " + resultCode);
                    String sku = result.getProductId();
                    if (resultCode == Activity.RESULT_OK) {
                        appendStatusText("In-app purchased product id: " + sku);
                        ...
                        appendStatusText("In-app purchase response code: " + responseCode);
                        appendStatusText("In-app purchase data: " + purchaseData);
                        ...
                        appendStatusText("In-app purchase failed to purchase product: " + sku);
                    }
                    appendStatusText("In-app purchase End.");
                }
            };
	    	...
	    	else
	    	{
                ...
                interstitial.setPlayStorePurchaseParams(IAPListener, null);
